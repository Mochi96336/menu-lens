...
export const createCandidateWorkspace = (menu, readingModel, onBack, onLocateProduct, onRemoveCandidate, onOpenComparison) => {
    ...
    const comparisonEntry = element("button", "candidate-workspace__comparison-entry", "比較考慮項目");
    ...
    const render = (state) => {
        ...
        comparisonEntry.setAttribute("aria-label", comparisonUnavailable ? "至少需要 2 道考慮項目才能比較" : `比較 ${workspace.count} 道考慮項目`);
        removeButtons.clear();
