...
export const createMenuOverview = (model, onSelectCategory, onBeginAnchorSelection, onCancelAnchorSelection, onSelectAnchor, onClearAnchor, onSelectAxis, onToggleCandidate, onShowOverview, onShowAll) => {
    ...
    intro.append(element("p", "eyebrow", "菜單全貌"), title, element("p", "menu-map__hint", "先看每區的份量、價位與代表菜名；點一區會在原位置展開，其他區域仍留在整張菜單裡。"), candidateSummary);
