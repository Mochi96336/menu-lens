...
import { closeCandidateWorkspace, createInitialMenuAppState, openCandidateWorkspace, removeAppCandidate, showCandidateInMenu, toggleAppCandidate, updateAppReading, } from "../customer/menu-app-state.js";
...
export const mountMenuApp = (root, menu) => {
    ...
    candidateWorkspace = createCandidateWorkspace(menu, model, closeCandidates, locateCandidateInMenu, removeCandidateFromWorkspace);
