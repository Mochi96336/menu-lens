...
export const designModels = Object.freeze([
  ...
  freezeModel({
    ...
    summary: "比較分類、料理序列與局部焦點在橫向介面中的導覽方式，以及它們對位置辨識、閱讀範圍與邊界穩定性的影響。",
  ...
  freezeModel({
    ...
    sections: [
      ...
      },
      {
        id: "stopped-lenses",
        title: "停止的局部鏡頭",
        summary: "Static Loupe 與 Folded Menu 顯示局部鏡頭的可讀性與空間限制，保留為停止結果與負面證據。",
        defaultObjectId: "13",
        objectIds: ["13", "14"],
      },
      {
        ...
        summary: "依序比較 pair-local 作用範圍、content weighting、stable drag 與 minimum target 對局部閱讀空間的分配。",
        defaultObjectId: "15",
  ...
  freezeModel({
    ...
    summary: "比較單一分類展開時的全局地標、返回位置與狀態說明，確認局部 focus 是否仍能表達完整菜單的存在。",
