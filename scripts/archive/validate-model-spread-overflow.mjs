...
assert.match(spreadBrowserReview, /category control is not fixed/);
assert.match(spreadBrowserReview, /category control is not pinned below return/);
assert.match(spreadBrowserReview, /pinned category activation/);
