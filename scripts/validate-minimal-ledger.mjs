...
const prototype = catalog.objects.find((entry) => entry.id === "05A");
if (!prototype
  || prototype.researchParentId !== "05"
  || prototype.family !== "document"
  || prototype.objectType !== "prototype"
  || prototype.disposition !== "provisional"
  || prototype.evidenceState !== "browser-verified"
  || prototype.validationProfile !== "minimal-ledger"
  || prototype.entrypoint !== "phases/05a-minimal-ledger/index.html"
  || prototype.sourcePr !== 17
  || prototype.sourceCommit !== "b13526d9033cca9b55a9e8a6c77127a807907f39") {
  throw new Error("05A Archive v2 identity or provenance drifted.");
}
...
console.log("05A Minimal Ledger validation passed: Archive v2 identity, 6 categories, 30 Products, minimal rows, inline detail and browser evidence.");
